    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(related_name='collections', db_column=b'parent_id', blank=True, to='pid.Domain', null=True, on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='ExtSystem',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(related_name='created', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('domain', models.ForeignKey(to='pid.Domain', on_delete=models.CASCADE)),
                ('editor', models.ForeignKey(related_name='edited', to=settings.AUTH_USER_MODEL, on_delete=models.CASCADE)),
                ('ext_system', models.ForeignKey(verbose_name=b'External system', blank=True, to='pid.ExtSystem', null=True, on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='Policy',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pid', models.ForeignKey(to='pid.Pid', on_delete=models.CASCADE)),
                ('proxy', models.ForeignKey(blank=True, to='pid.Proxy', null=True, on_delete=models.CASCADE)),
            ],
        ),
        migrations.AddField(
            model_name='pid',
            name='policy',
            field=models.ForeignKey(blank=True, to='pid.Policy', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='domain',
            name='policy',
