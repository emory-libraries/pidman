...
class Migration:
    ...
    def forwards(self, orm):
        ...
        db.execute('CREATE SEQUENCE pid_pid_pid_seq START %s OWNED BY pid_pid.pid',
                (max_noid+1,))
        db.execute('DROP FUNCTION IF EXISTS mint_noid(varchar)')
        db.execute('DROP LANGUAGE IF EXISTS plperlu')
    ...
    def backwards(self, orm):
        db.execute('DROP SEQUECE pid_pid_pid_seq')
